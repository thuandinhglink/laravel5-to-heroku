...
// API. >>docs: http://api.jqueryui.com/jQuery.widget/ >>demos:
// http://jqueryui.com/widget/
    ...
    $.widget = function (name, base, prototype) {
        ...
        $.extend(constructor, existingConstructor, {
            ...
            // is redefined after a widget inherits from it
            _childConstructors: []
        });
        ...
        // instance otherwise we'll modify the options hash on the prototype
        ...
        constructor.prototype = $.widget.extend(basePrototype, {
            ...
            // draggable:start don't prefix for widgets that aren't DOM-based
        ...
        // that are inheriting from it and redefine all of them so that they
        // inherit from the new version of this widget. We're essentially
        // trying to replace one level in the prototype chain.
        if (existingConstructor) {
            ...
            // constructor so the old child constructors can be garbage
            // collected
    ...
    $.widget.bridge = function (name, object) {
        ...
        $.fn[name] = function (options) {
            ...
            if (isMethodCall) {
                ...
                // method return undefined instead of the jQuery instance
    ...
    $.Widget.prototype = {
        ...
        _setOptionClasses: function (value) {
            ...
            for (classKey in value) {
                ...
                // _removeClass() call on the next line is going to destroy the
                // reference to the current elements being tracked. We need to
                // save a copy of this collection so that we can add the new
                // classes below.
                elements = $(currentElements.get());
                this._removeClass(currentElements, classKey);

                // We don't use _addClass() here, because that uses
                // this.options.classes for generating the string of classes.
                // We want to use the value passed in from _setOption(), this
                // is the new value of the classes option which was passed to
...
// key. >>docs: http://api.jqueryui.com/data-selector/
...
// elements. >>docs: http://api.jqueryui.com/disableSelection/
...
// easing. Required by all other effects. jscs:enable maximumLineLength >>docs:
// http://api.jqueryui.com/category/effects-core/ >>demos:
...
// for rgba and hsla spaces
        ...
        function stringParse(string) {
            ...
            if (rgba.length) {
                ...
                // alpha is 0 chrome, (and maybe others) return "transparent"
                // as rgba(0,0,0,0)
                        ...
                        each(spaces, function (spaceName, space) {
                            ...
                            each(space.props, function (key, prop) {
                                ...
                                if (!inst[cache] && space.to) {
                                    ...
                                    // copy it if the key was alpha, we don't
                                ...
                                // for ALL properties. call clamp with
                                // alwaysAllowEmpty
...
// https://code.google.com/p/maashaack/source/browse/packages/graphics/trunk/src/graphics/colors/HUE2RGB.as?r=5021
        ...
        spaces.hsla.to = function (rgba) {
            ...
            // saturation = 0% otherwise, saturation is based on the ratio of
            // chroma (diff) to lightness (add)
            if (diff === 0) {
                s = 0;
            }
            else if (l <= 0.5) {
...
// Support: jQuery <1.8
    ...
    (function () {
        ...
        if ($.uiBackCompat !== false) {
            $.extend($.effects, {
                ...
                createWrapper: function (element) {
                    ...
                    // Hotfix for jQuery 1.4 since some change in wrap() seems
        ...
        $.extend($.effects, {
            ...
            // Creates a placeholder element so that the original element can
            // be made absolute
            createPlaceholder: function (element) {
                ...
                // https://bugs.webkit.org/show_bug.cgi?id=107380 Support:
                // Safari
                element.css({
                ...
                if (/^(static|relative)/.test(cssPosition)) {
                    ...
                    placeholder = $("<" + element[0].nodeName + ">").insertAfter(element).css({
                        ...
                        // Convert inline to inline block to account for inline
                        // elements that turn to inline block based on content
                        // (like img)
            ...
            effect: function ( /* effect, options, speed, callback */) {
                var args = _normalizeArguments.apply(this, arguments),
                    ...
                    prefilter = function (next) {
                        ...
                        // See $.uiBackCompat inside of run() for removal of
                        // defaultMode in 1.13
                ...
                function run(next) {
                    ...
                    if ($.uiBackCompat !== false && !defaultMode) {
                        if (elem.is(":hidden") ? mode === "hide" : mode === "show") {
                            ...
                            // Call the core method to track "olddisplay"
                            // properly
                            elem[mode]();
                            done();
                        }
...
// time. >>docs: http://api.jqueryui.com/drop-effect/ >>demos:
// http://jqueryui.com/effect/
...
// an element to its original wholeness. jscs:enable maximumLineLength >>docs:
// http://api.jqueryui.com/explode-effect/ >>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectExplode = $.effects.define("explode", "hide", function (options, done) {
        ...
        for (i = 0; i < rows; i++) { // ===>
            ...
            for (j = 0; j < cells; j++) { // |||
                ...
                // absolute positioned within a wrapper div off the -left and
                // -top equal to size of our pieces
                element
                    .clone()
                    .appendTo("body")
                    .wrap("<div></div>")
                    ...
                    // absolute positioned based on where the original was
                    // located +left and +top equal to the size of pieces
                    .parent()
...
//>>group: Effects
//>>description: Highlights the background of an element in a defined color for
// a custom duration. >>docs: http://api.jqueryui.com/highlight-effect/
// >>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectHighlight = $.effects.define("highlight", "show", function (options, done) {
        ...
        element
            .css({
                ...
                backgroundColor: options.color || "#ff9"
            })
            .animate(animation, {
                queue: false,
                duration: options.duration,
...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectSize = $.effects.define("size", function (options, done) {
        ...
        if (scale === "content" || scale === "both") {
            ...
            // TODO: is this right? should we include anything with css width
            // specified as well
        ...
        element.animate(to, {
            ...
            complete: function () {
                ...
                if (!restore) {
                    ...
                    // Need to save style here so that automatic style
                    // restoration doesn't restore to the original styles from
...
//>>label: Puff Effect
//>>group: Effects
//>>description: Creates a puff effect by scaling the element up and hiding it
// at the same time. >>docs: http://api.jqueryui.com/puff-effect/ >>demos:
// http://jqueryui.com/effect/
...
//>>group: Effects
//>>description: Pulsates an element n times by changing the opacity to zero
// and back. >>docs: http://api.jqueryui.com/pulsate-effect/ >>demos:
// http://jqueryui.com/effect/
    ...
    $.ui.focusable = function (element, hasTabindex) {
        ...
        if (/^(input|select|textarea|button|object)$/.test(nodeName)) {
            ...
            if (focusableIfVisible) {
                ...
                // However, controls within the fieldset's legend do not get
                // disabled. Since controls generally aren't placed inside
                // legends, we skip this portion of the check.
...
// overwrites the form prop with a string, so we need to find the proper form.
    ...
    var formResetMixin = $.ui.formResetMixin = {
        ...
        _bindFormResetHandler: function () {
            ...
            if (!instances.length) {
                ...
                // We don't use _on() here because we use a single event
                // handler per form
...
// 1.7 anymore). See #11197 for why we're not using feature detection.
    if ($.fn.jquery.substring(0, 3) === "1.7") {
        ...
        // .outerHeight() Unlike jQuery Core 1.8+, these only support numeric
        // values to set the dimensions in pixels
...
//>>docs: http://api.jqueryui.com/labels/
    ...
    var labels = $.fn.labels = function () {
        ...
        // support them as well as document fragments. control.labels does not
...
//>>group: Widgets
// jscs:disable maximumLineLength
//>>description: Displays collapsible content panels for presenting information
// in a limited amount of space. jscs:enable maximumLineLength >>docs:
// http://api.jqueryui.com/accordion/ >>demos: http://jqueryui.com/accordion/
// >>css.structure: ../../themes/base/core.css >>css.structure:
// ../../themes/base/accordion.css >>css.theme: ../../themes/base/theme.css
    ...
    var widgetsAccordion = $.widget("ui.accordion", {
        ...
        _setOptionDisabled: function (value) {
            ...
            // Support: IE8 Only
            // #5332 / #6059 - opacity doesn't cascade to positioned elements
            // in IE so we need to add the disabled class to the headers and
            // panels
        ...
        _toggle: function (data) {
            ...
            // order if we're opening from collapsed state, remove the previous
            // header from the tab order if we're collapsing, then keep the
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        _create: function () {
            ...
            this._on({
                ...
                // clicking them (focus should always stay on UL during
                // navigation).
                ...
                "click .ui-menu-item": function (event) {
                    ...
                    if (!this.mouseHandled && target.not(".ui-state-disabled").length) {
                        ...
                        if (target.has(".ui-menu").length) {
                            ...
                            // stay active. Otherwise, blur the active item
                ...
                "mouseenter .ui-menu-item": function (event) {
                    ...
                    // #10458. Prevents focusing the wrong item when typeahead
                    // causes a scroll while the mouse is over an item in the
                    // menu
                    ...
                    // focused menu item to avoid a jump caused by adjacent
                    // elements both having a class with a border
        ...
        _keydown: function (event) {
            ...
            switch (event.keyCode) {
                ...
                default:
                    ...
                    // character pressed to move down the menu to the first
        ...
        _startOpening: function (submenu) {
            ...
            // pixel shift in the submenu position when mousing over the caret
            // icon
        ...
        // active it closes all menus.  If passed an argument, it will search
        // for menus BELOW
        ...
        select: function (event) {
            ...
            // this point, but the tests don't trigger mouseenter before click.
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            // arrow, so we use the suppressKeyPressRepeat flag to avoid
            // handling keypress events when we know the keydown event was used
            // to modify the search term. #7799
            ...
            // element IE also treats inputs as contentEditable All other
            // element types are determined by whether or not they're
            // contentEditable
                    ...
                    switch (event.keyCode) {
                        ...
                        case keyCode.ENTER:
                            ...
                            if (this.menu.active) {
                                ...
                                // occur which causes forms to submit
                                suppressKeyPress = true;
                                event.preventDefault();
                        ...
                        case keyCode.ESCAPE:
                            if (this.menu.element.is(":visible")) {
                                ...
                                // behavior for escape Single press can mean
                                // undo or clear Double press in IE means clear
                                // the whole form
                                event.preventDefault();
                            }
                            break;
            ...
            this._on(this.menu.element, {
                mousedown: function (event) {
                    ...
                    // event.preventDefault() so we set a flag to know when we
                    ...
                    this._delay(function () {
                        ...
                        // Support: IE 8 only
                        // Right clicking a menu item or selecting text from
                        // the menu items will result in focus moving out of
                        // the input. However, we've already received and
                        // ignored the blur event because of the cancelBlur
                        // flag set above. So we restore focus to ensure that
                        // the menu closes properly based on the user's next
                        // actions.
            ...
            // the value when navigating through history, so we re-enable
            // autocomplete if the page is unloaded before the widget is
            // destroyed. #7790
    ...
    var widgetsControlgroup = $.widget("ui.controlgroup", {
        ...
        _initWidgets: function () {
            ...
            $.each(this.options.items, function (widget, selector) {
                ...
                // can't determine first / last elements until all enhancments
                // are done.
                ...
                that.element
                    ...
                    .each(function () {
                        ...
                        // We need to clone the default options for this type
                        // of widget to avoid polluting the variable options
                        // which has a wider scope than a single widget.
                        ...
                        // reference from the outermost element for changing
                        // options and refresh
        ...
        refresh: function () {
            ...
            // We filter here because we need to track all childWidgets not
            ...
            if (children.length) {
                ...
                // is done before determining first and last
...
//>>label: Checkboxradio
//>>group: Widgets
//>>description: Enhances a form with multiple themeable checkboxes or radio
// buttons. >>docs: http://api.jqueryui.com/checkboxradio/ >>demos:
// http://jqueryui.com/checkboxradio/ >>css.structure:
// ../../themes/base/core.css >>css.structure: ../../themes/base/button.css
// >>css.structure: ../../themes/base/checkboxradio.css >>css.theme:
// ../../themes/base/theme.css
    ...
    $.widget("ui.checkboxradio", [$.ui.formResetMixin, {
        ...
        _getCreateOptions: function () {
            ...
            // element type error first, rather then the error for lack of a
            // label. Often if its the wrong type, it won't have a label (e.g.
            // calling on a div, btn, etc)
            this._readType();
            ...
            // sure it does not contain the input itself.
            this.label.contents().not(this.element[0]).each(function () {

                // The label contents could be text, html, or a mix. We concat
                // each element to get a string representation of the label,
                // without the input as part of it.
    ...
    $.widget("ui.button", {
        ...
        _getCreateOptions: function () {
            var disabled,
                ...
                // This is to support cases like in jQuery Mobile where the
                // base widget does have an implementation of _getCreateOptions
                options = this._super() || {};
        ...
        _create: function () {
            ...
            // _getCreateOptions, because null may have been passed on init
            // which would override what was set in _getCreateOptions
            if (this.options.disabled == null) {
        ...
        _updateIcon: function (option, value) {
            ...
            // ui-widget-icon-block class and remove the iconSpace if there is
            // one.
            if (displayBlock) {
                ...
                // ui-widget-icon-block class and add the space if it does not
                // exist
                if (!this.iconSpace) {
                    this.iconSpace = $("<span> </span>");
        ...
        _setOption: function (key, value) {
            ...
            // Make sure we can't end up with a button that has neither text
            // nor icon
            if (key === "showLabel") {
            ...
            if (key === "label") {
                if (this.isInput) {
                    ...
                    // the value this avoids removal of the icon when setting
                    // label text
        ...
        refresh: function () {
            ...
            // this otherwise check for the disabled class to determine state
...
// dates. >>docs: http://api.jqueryui.com/datepicker/ >>demos:
// http://jqueryui.com/datepicker/ >>css.structure: ../../themes/base/core.css
// >>css.structure: ../../themes/base/datepicker.css >>css.theme:
// ../../themes/base/theme.css
    ...
    function datepicker_getZindex(elem) {
        ...
        while (elem.length && elem[0] !== document) {
            ...
            // ignored by the browser This makes behavior of this function
            // consistent across browsers WebKit always returns auto if the
            ...
            if (position === "absolute" || position === "relative" || position === "fixed") {
                ...
                // we ignore the case of nested elements with an explicit value
                // of 0 <div style="z-index: -10;"><div style="z-index:
                // 0;"></div></div>
   ...
   allowing multiple different settings on the same page. */
    ...
    function Datepicker() {
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            buttonImageOnly: false, // True if the image appears alone, false
                                    // if it appears on a button
            ...
            // displayed year (c-nn:c+nn), absolute (nnnn:nnnn), or a
            // combination of the above (nnnn:-n)
            ...
            // name(s) or "", [2] = cell title (optional), e.g.
	 ...
	 */
        ...
        _inlineDatepicker: function (target, inst) {
            ...
            // on disconnected elements http://bugs.jqueryui.com/ticket/7552 -
	 ...
	 */
        _optionDatepicker: function (target, name, value) {
            ...
            if (inst) {
                ...
                // reformat the old minDate/maxDate values if dateFormat
                // changes and a new minDate/maxDate isn't provided
...
// certain widgets. >>docs: http://api.jqueryui.com/mouse/
    ...
    var widgetsMouse = $.widget("ui.mouse", {
        ...
        _mouseMove: function (event) {
            ...
            // inside the document at least once. This prevents the firing of
            // mouseup in the case of IE<9, which will fire a mousemove event
            // if content is placed under the cursor. See #7778 Support: IE <9
            if (this._mouseMoved) {
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseUp: function (event) {
            ...
            if (this.handleElement.is(event.target)) {
                ...
                // The interaction is over; whether or not the click resulted
                // in a drag, focus the element
                this.element.trigger("focus");
            }
        ...
        _getParentOffset: function () {
            ...
            // calculated on start, since the following happened: 1. The
            // position of the helper is absolute, so it's position is
            // calculated based on the next positioned parent 2. The actual
            // offset parent is a child of the scroll parent, and the scroll
            // parent isn't the document, which means that the scroll is
            // included in the initial calculation of the offset of the parent,
        ...
        start: function (event, ui, draggable) {
            ...
            $(draggable.options.connectToSortable).each(function () {
                ...
                if (sortable && !sortable.options.disabled) {
                    ...
                    // containerCache which is used in drag. This ensures it's
                    // initialized and synchronized with any changes that might
                    // have happened on the page since initialization.
        ...
        drag: function (event, ui, draggable) {
            $.each(draggable.sortables, function () {
                ...
                if (innermostIntersecting) {
                    ...
                    // set it once, so that the move-in stuff gets fired only
                    // once.
                    if (!sortable.isOver) {
                        sortable.isOver = 1;
                        ...
                        // Fire the start events of the sortable with our
                        // passed browser event, and our own helper (so it
                        // doesn't create a new one)
                        event.target = sortable.currentItem[0];
                        sortable._mouseCapture(event, true);
                        sortable._mouseStart(event, true, true);

                        // Because the browser event is way off the new
                        // appended portlet, modify necessary variables to
                        // reflect the changes
                        ...
                        // zone, used solely in the revert option to handle
                        // "valid/invalid".
                        draggable.dropped = sortable.element;

                        // Need to refreshPositions of all sortables in the
                        // case that adding to one sortable changes the
                    ...
                    if (sortable.currentItem) {
                        ...
                        // can potentially reflect a relative position, while
                    ...
                    // intersected before, we fake the drag stop of the
                    // sortable, but make sure it doesn't remove the helper by
                    // using cancelHelperRemoval.
                    if (sortable.isOver) {
                        ...
                        // considering the sortable may have modified them in
                        // unexpected ways. (#8809, #10669)
                        ...
                        // case removing from one sortable changes the location
                        // of other sortables (#9675)
                        $.each(draggable.sortables, function () {
                            this.refreshPositions();
                        });
                    }
 ...
 */
    ...
    $.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function (event, ui) {
            ...
            $(o.alsoResize).each(function () {
                var el = $(this),
                    start = $(this).data("ui-resizable-alsoresize"), style = {},
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.dialog", {
        ...
        open: function () {
            ...
            // when opening. The overlay shouldn't move after the dialog is
            // open so that modeless dialogs opened after the modal dialog
            // stack properly.
            if (this.overlay) {
        ...
        _keepFocus: function (event) {
            ...
            // event.preventDefault() so we check again later
        ...
        _makeResizable: function () {
            var that = this,
                ...
                // stylesheet but dialogs have to use absolute or fixed
                // positioning
        ...
        _size: function () {
            ...
            // .ui-dialog-content divs will both have width and height set, so
        ...
        _createOverlay: function () {
            ...
            if (!this.document.data("ui-dialog-overlays")) {
                ...
                // instances is safe because the dialogs stack and must be
...
//>>demos: http://jqueryui.com/droppable/
    ...
    $.widget("ui.droppable", {
        ...
        // Extension points just to make backcompat sane and avoid duplicating
        // logic TODO: Remove in 1.13 along with call to it below
...
// percentage, and other progress indicators. jscs:enable maximumLineLength
// >>docs: http://api.jqueryui.com/progressbar/ >>demos:
// http://jqueryui.com/progressbar/ >>css.structure: ../../themes/base/core.css
// >>css.structure: ../../themes/base/progressbar.css >>css.theme:
// ../../themes/base/theme.css
...
//>>group: Widgets
// jscs:disable maximumLineLength
//>>description: Duplicates and extends the functionality of a native HTML
// select element, allowing it to be customizable in behavior and appearance
// far beyond the limitations of a native select. jscs:enable maximumLineLength
// >>docs: http://api.jqueryui.com/selectmenu/ >>demos:
// http://jqueryui.com/selectmenu/ >>css.structure: ../../themes/base/core.css
// >>css.structure: ../../themes/base/selectmenu.css,
// ../../themes/base/button.css >>css.theme: ../../themes/base/theme.css
    ...
    var widgetsSelectmenu = $.widget("ui.selectmenu", [$.ui.formResetMixin, {
        ...
        _drawButton: function () {
            ...
            this.button.one("focusin", function () {
                ...
                // Delay rendering the menu items until the button receives
                // focus. The menu may have already been rendered via a
                // programmatic open.
                if (!that._rendered) {
                    that._refreshMenu();
                }
            ...
            this.menuInstance = this.menu
                .menu({
                    ...
                    select: function (event, ui) {
                        ...
                        // Support: IE8
                        // If the item was selected via a click, the text
                        // selection will be destroyed in IE
                        that._setSelection();
                    ...
                    focus: function (event, ui) {
                        ...
                        // Prevent inital focus from firing and check if its a
                        // newly focused item
        ...
        open: function (event) {
            ...
            // If this is the first time the menu is being opened, render the
            // items
            if (!this._rendered) {
                this._refreshMenu();
            }
        ...
        _buttonEvents: {
            ...
            // Prevent text selection from being reset when interacting with
            // the selectmenu (#10144)
            mousedown: function () {
                var selection;
        ...
        _toggleAttr: function () {
            ...
            // We can't use two _toggleClass() calls here, because we need to
            // make sure we always remove classes first and add them second,
            // otherwise if both classes have the same theme class, it will be
            // removed after we add it.
...
// keyboard. >>docs: http://api.jqueryui.com/slider/ >>demos:
// http://jqueryui.com/slider/ >>css.structure: ../../themes/base/core.css
// >>css.structure: ../../themes/base/slider.css >>css.theme:
// ../../themes/base/theme.css
    ...
    var widgetsSlider = $.widget("ui.slider", $.ui.mouse, {
        ...
        options: {
            ...
            classes: {
                ...
                // framework class for this element, but worked best visually
        ...
        _setOption: function (key, value) {
            ...
            switch (key) {
                ...
                case "values":
                    ...
                    // Start from the last handle to prevent unreachable
                    // handles (#9046)
        ...
        // step _values( index ) returns single value trimmed by min and max,
        // aligned by step
        ...
        _calculateNewMax: function () {
            ...
            if (max > this.options.max) {
                ...
                //If max is not divisible by step, rounding off may increase
                // its value
                max -= step;
            }
...
//>>css.structure: ../../themes/base/sortable.css
    ...
    var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
		 ...
		 */
            ...
            // position to absolute TODO: Still need to figure out a way to
            ...
            // visiblebefore getting its correct position
            this._mouseDrag(event);
            return true;
        ...
        _mouseDrag: function (event) {
            ...
            for (i = this.items.length - 1; i >= 0; i--) {
                ...
                // all items from other containers. This works because when
                // moving an item from one container to another the
                // currentContainer is switched before the placeholder is
                // moved.  Without this, moving items in "sub-sortables" can
                // cause the placeholder to jitter between the outer and inner
                // container.
            ...
            if (!o.placeholder || o.placeholder.constructor === String) {
                ...
                o.placeholder = {
                    ...
                    update: function (container, p) {
                        ...
                        // don't force sizes - the class is responsible for
                        // that 2. The option 'forcePlaceholderSize can be
        ...
        _contactContainers: function (event) {
            ...
            if (this.containers.length === 1) {
                ...
                // When entering a new container, we will find the item with
                // the least distance and append our item near it
                dist = 10000;
        ...
        _getParentOffset: function () {
            ...
            // pageX/pageY includes this information with an ugly IE fix
        ...
        _generatePosition: function (event) {
            ...
            // relative elements: 1. If the css position is relative 2. and the
            // scroll parent is the document or similar to the offset parent we
            // have to refresh the relative offset during the scroll so there
            // are no jumps
        ...
        _rearrange: function (event, i, a, hardRefresh) {
            ...
            // higher after every append 3. on the local scope, we copy the
            // counter variable, and check in the timeout, if it's still the
            // same 4. this lets only the last addition to the timeout stack
            // through
        ...
        _clear: function (event, noPropagation) {
            ...
            // currentItem Note: don't do it if the current item is already
            // removed (by a user), or it gets reappended (see #4088)
...
//>>label: Spinner
//>>group: Widgets
//>>description: Displays buttons to easily input numbers via the keyboard or
// mouse. >>docs: http://api.jqueryui.com/spinner/ >>demos:
// http://jqueryui.com/spinner/ >>css.structure: ../../themes/base/core.css
// >>css.structure: ../../themes/base/spinner.css >>css.theme:
// ../../themes/base/theme.css
    ...
    $.widget("ui.spinner", {
        ...
        _create: function () {
            ...
            // marked as invalid in Firefox, see #9573.
            if (this.value() !== "") {
        ...
        _events: {
            ...
            "mousedown .ui-spinner-button": function (event) {
                ...
                // We never want the buttons to have focus; whenever the user
                // is
                // interacting with the spinner, the focus should be on the
                // input. If the input is focused then this.previous is
                // properly set from when the input first received focus. If
                // the input is not focused then we need to set this.previous
                ...
                function checkFocus() {
                    ...
                    if (!isActive) {
                        ...
                        // focus moved off of the input because the user
                ...
                // IE doesn't prevent moving focus even with
                // event.preventDefault() so we set a flag to know when we
                // should ignore the blur event and check (again) if focus
    ...
    $.widget("ui.tabs", {
        ...
        _tabKeydown: function (event) {
            ...
            if (!event.ctrlKey && !event.metaKey) {
                ...
                // already selected. Otherwise AT may confuse the user by
                // stating that they need to activate the tab, but the tab will
                // already be activated by the time the announcement finishes.
        ...
        _processTabs: function () {
            ...
            this.tablist
                ...
                // Support: IE <9
                // Preventing the default action in mousedown doesn't prevent
                // IE
                // from focusing the element, so if the anchor gets focused,
                // blur. We don't have to worry about focusing the previously
                // focused element since clicking on a non-focusable element
                // should focus the body anyway.
        ...
        _toggle: function (event, eventData) {
            ...
            // from the tab order. If we're collapsing, then keep the
        ...
        load: function (index, event) {
            ...
            // beforeSend, but as of 1.8, $.ajax() always returns a jqXHR
            // object.
        ...
        _ajaxSettings: function (anchor, event, eventData) {
            ...
            return {
                ...
                // Support: IE <11 only
                // Strip any hash that exists to prevent errors with the Ajax
                // request
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.tooltip", {
        ...
        _updateContent: function (target, event) {
            ...
            content = contentOption.call(target[0], function (response) {
                ...
                that._delay(function () {
                    ...
                    // doesn't exist natively. To improve performance, the
                    // native event object is reused and the type is changed.
                    // Therefore, we can't rely on the type being correct after
                    // the event finished bubbling, so we set it back to the
                    // previous value. (#8740)
                    if (event) {
        ...
        _open: function (event, target, content) {
            ...
            // correct accessible attributes. For mouse events, set to empty
            // string to avoid native tooltip showing up (happens only when
            ...
            // soon as the tooltip is visible, position the tooltip using the
            // most recent event. Adds the check to add the timers only when
            // both delay and track options are set (#14682)
        ...
        close: function (event) {
            ...
            if (!tooltipData) {
                ...
                // We set ui-tooltip-open immediately upon open (in open()),
                // but only set the additional data once there's actually
                // content to show (in _open()). So even if the tooltip doesn't
                // have full data, we always remove ui-tooltip-open in case
                // we're in the period between open() and _open().
            ...
            // closing to avoid an infinite loop in case the tooltip becomes
            // disabled on close
