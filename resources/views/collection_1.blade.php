...
</header><?php $collection_detail= json_decode('[]', true); $collection_detail['multipleData'] = json_decode('[]', true); ?><?php $widgetUseData = json_decode('[]', true); ?><section class="bg-half bg-light d-table w-100">
    <div class="container">
