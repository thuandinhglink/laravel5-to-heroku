...
<head>
    ...
    <div class="container">
        <?php $logo= json_decode('{"file":"605c195407471.jpeg"}', true); $logo['multipleData'] = json_decode('[]', true); ?><div>
