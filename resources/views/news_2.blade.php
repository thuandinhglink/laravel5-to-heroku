...
</header><?php $news_detail= json_decode('[]', true); $news_detail['multipleData'] = json_decode('[]', true); ?><?php $widgetUseData = json_decode('[]', true); ?><!-- Hero Start -->
<section class="bg-half bg-light d-table w-100">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="page-next-level">
                    <h4 class="title"> {{$currentNewsData["name"]}} </h4>
                    <div class="page-next">
                        <nav aria-label="breadcrumb" class="d-inline-block">
                            <ul class="breadcrumb bg-white rounded shadow mb-0">
                                <li class="breadcrumb-item"><a href="home">Landrick</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{$currentNewsData["name"]}}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
