 ...
 *
 * The Service is Defined for EmailTemplate.
 *
 * PHP version 7.1.3
 *
...
class EmailTemplateServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        $this->publishes(
            [
            __DIR__.'/../Config/config.php' => config_path('emailtemplate.php'),
            ],
            'config'
        );
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'emailtemplate');
        }
    }
