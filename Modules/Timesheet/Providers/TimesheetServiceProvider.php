...
class TimesheetServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('views/modules/timesheet');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/timesheet';
        }, \Config::get('view.paths')), [$sourcePath]), 'timesheet');
    }
    ...
    {
        $langPath = resource_path('lang/modules/timesheet');
